        ...
        <sec:ifNotLoggedIn>
            ...
            <div id="controller-list" role="navigation">
                ...
                <ul>
                    <g:each var="c" in="${grailsApplication.controllerClasses.find { it.fullName=="grails.plugin.springsecurity.LoginController" } }">
                        <li class="controller"><g:link controller="$c.logicalPropertyName}">${c.fullName}</g:link></li>                    </g:each>
                </ul>
            </div>
        </sec:ifNotLoggedIn>
        </body>
